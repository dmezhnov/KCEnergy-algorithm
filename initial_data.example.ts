...
export const requests_i_j_k_l_s_l0: matrix = requestsEmptyMatrix;
requests_i_j_k_l_s_l0.matrix_title['#значение'] = 'requests_i_j_k_l_s_l0';
...
if (import.meta.main) {
    await requests_i_j_k_l_s_l0.save('algorithm/build/initial_data.example.lang', false);
